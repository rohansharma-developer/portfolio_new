...
const CELL_HIGHLIGHT = '#a6e3a1';
const ELECTRON_COLOR = '#eeeeee';
...
const btn_designer = document.querySelector(".btn--xbox"),
      designer = document.querySelector(".btn--xbox > .glitch_effect");
      const btn_dev = document.querySelector(".btn--ps4"),
      developer = document.querySelector(".btn--ps4 > .glitch_effect");
      const btn_linux = document.querySelector(".btn--pc"),
      linux = document.querySelector(".btn--pc > .glitch_effect");
      const nav_btn_1 = document.querySelector(".nav_1"),
      btn_1 = document.querySelector(".nav_1 > .glitch_effect");
      const nav_btn_2 = document.querySelector(".nav_2"),
      btn_2 = document.querySelector(".nav_2 > .glitch_effect");
      const nav_btn_3 = document.querySelector(".nav_3"),
      btn_3 = document.querySelector(".nav_3 > .glitch_effect");
      const nav_btn_4 = document.querySelector(".nav_4"),
      btn_4 = document.querySelector(".nav_4 > .glitch_effect");



btn_designer.onmouseenter = event => {  
  let iteration = 0;
  
  clearInterval(interval);
  
  interval = setInterval(() => {
    designer.innerText = designer.innerText
      .split("")
      .map((letter, index) => {
        if(index < iteration) {
          return designer.dataset.value[index];
        }
    ...
    if(iteration >= designer.dataset.value.length){ 
      clearInterval(interval);
    }
...
btn_dev.onmouseenter = event => {  
  let iteration = 0;
  
  clearInterval(interval);
  
  interval = setInterval(() => {
    developer.innerText = developer.innerText
      .split("")
      .map((letter, index) => {
        if(index < iteration) {
          return developer.dataset.value[index];
        }
    ...
    if(iteration >= developer.dataset.value.length){ 
      clearInterval(interval);
    }
...
btn_linux.onmouseenter = event => {  
  let iteration = 0;
  
  clearInterval(interval);
  
  interval = setInterval(() => {
    linux.innerText = linux.innerText
      .split("")
      .map((letter, index) => {
        if(index < iteration) {
          return linux.dataset.value[index];
        }
    ...
    if(iteration >= linux.dataset.value.length){ 
      clearInterval(interval);
    }
...
nav_btn_1.onmouseenter = event => {  
  let iteration = 0;
  
  clearInterval(interval);
  
  interval = setInterval(() => {
    btn_1.innerText = btn_1.innerText
      .split("")
      .map((letter, index) => {
        if(index < iteration) {
          return btn_1.dataset.value[index];
        }
    ...
    if(iteration >= btn_1.dataset.value.length){ 
      clearInterval(interval);
    }
...
nav_btn_3.onmouseenter = event => {  
  let iteration = 0;
  
  clearInterval(interval);
  
  interval = setInterval(() => {
    btn_3.innerText = btn_3.innerText
      .split("")
      .map((letter, index) => {
        if(index < iteration) {
          return btn_3.dataset.value[index];
        }
    ...
    if(iteration >= btn_3.dataset.value.length){ 
      clearInterval(interval);
    }
...
nav_btn_2.onmouseenter = event => {  
  let iteration = 0;
  
  clearInterval(interval);
  
  interval = setInterval(() => {
    btn_2.innerText = btn_2.innerText
      .split("")
      .map((letter, index) => {
        if(index < iteration) {
          return btn_2.dataset.value[index];
        }
    ...
    if(iteration >= btn_2.dataset.value.length){ 
      clearInterval(interval);
    }
...
nav_btn_4.onmouseenter = event => {  
  let iteration = 0;
  
  clearInterval(interval);
  
  interval = setInterval(() => {
    btn_4.innerText = btn_4.innerText
      .split("")
      .map((letter, index) => {
        if(index < iteration) {
          return btn_4.dataset.value[index];
        }
    ...
    if(iteration >= btn_4.dataset.value.length){ 
      clearInterval(interval);
    }
